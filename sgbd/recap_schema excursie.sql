...
(
  COD_EXCURSIE NUMBER(9, 0)  
, COD_TURIST NUMBER(9, 0)  
, DATA_START DATE 
, DATA_END DATE 
, DATA_ACHIZITIE DATE 
, DISCOUNT NUMBER(9, 2) 
...
insert into turist (id_turist,nume, prenume) values(9, 'Tudor', 'Laurentiu');
insert into turist (id_turist,nume, prenume) values(10, 'Zamfirache','Nadia');
insert into turist (id_turist,nume, prenume) values(11,'Anghel','Simona');
