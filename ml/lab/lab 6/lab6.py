...
print('the most significant features is ', np.argmax(np.abs(model.coef_)) + 1)
print('the second most significant features is ', np.argsort(np.abs(model.coef_))[-2] + 1)
print('the 3rd most significant features is ', np.argsort(np.abs(model.coef_))[-3] + 1)
print('the 4th most significant features is ', np.argsort(np.abs(model.coef_))[-4] + 1)
print('the least significant features is ', np.argmin(np.abs(model.coef_)) + 1) 
